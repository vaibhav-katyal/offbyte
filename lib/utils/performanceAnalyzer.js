...
export function generateReport(analysis, startupMode = false) {
  ...
  report += chalk.bold.cyan('â•‘         offbyte SCALABILITY REPORT                      â•‘\n');
  report += chalk.bold.cyan('â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•\n\n');
  ...
  report += chalk.gray('Generated by offbyte Benchmark Tool\n');
