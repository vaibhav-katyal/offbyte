...
export async function generateSmartAPI(projectPath, options = {}) {
  ...
  console.log(chalk.cyan('\nðŸŽ¯ offbyt Smart API Generation\n'));
  ...
  if (isSQL && resources.length > 0) {
    ...
    try {
      ...
      sqlStep.succeed(chalk.green('âœ… SQL files generated in backend/sql/'));
      console.log(chalk.gray('   â€¢ 01_schema.sql'));
      console.log(chalk.gray('   â€¢ 02_crud_operations.sql'));
      console.log(chalk.gray('   â€¢ 03_relationships_joins.sql'));
      console.log(chalk.gray('   â€¢ 04_seed_data.sql\n'));
    } catch (error) {
